        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item text-danger active" aria-current="page">Visi & Misi</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        <p class="d-inline-block border rounded-pill text-light py-1 px-4">Visi & Misi</p>
                        <p class="text-white mb-4 pb-2">Visi <b>Menara Pest</b> adalah menjadi Pest Management yang unggul dan kompetitif dalam memberikan pelayanan terbaik untuk kepuasan pelanggan.
                        </p>
                        
                        <p class="text-white mb-4 pb-2"> Misi <b>Menara Pest</b> adalah
                            <ul class="text-white">
                                <li>Memberikan pelayanan yang tanggap, efektif, efisien dan tepat sasaran</li>
                                <li>Meningkatkan tenaga-tenaga ahli yang berkualitas dalam aspek attitude, skill dan knowledge</li>
                                <li>Meningkatkan mutu pelayanan secara berkelanjutan</li>
                                <li>Mengoptimalkan inovasi perkembangan teknologi terbaru</li>
                            </ul></p>
                        <div class="row g-4">
                            <div class="col-6">
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="http://www.aybitari.com/wp-content/uploads/2019/05/pest_kontrol.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
