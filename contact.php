            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="h-100 bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">Komp. Setia Jadi Blok D No 4, Bandar Khalipah, Deli Serdang</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="h-100 bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">+628 5219 8355 14</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="h-100 bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">menaralimapuluh@gmail.com</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                  <div class="h-100" style="min-height: 400px;">
                        ...
                        src="https://maps.google.com/maps?width=700&amp;height=440&amp;hl=en&amp;q=Komp.%20Setia%20Jadi%20Blok%20D%20No%204%2C%20Bandar%20Khalipah%2C%20Deli%20Serdang+(Title)&amp;ie=UTF8&amp;t=&amp;z=10&amp;iwloc=B&amp;output=embed"
