...
<body>
    ...
    ?>    
        ...
        <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container py-5">
                <h1 class="display-3 text-white mb-5 animated slideInDown">Program Menara Pest</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb text-uppercase mb-0">
                        <li class="breadcrumb-item"><a class="text-white" href="#">Produk Jasa Menara Pest</a></li>
                        <li class="breadcrumb-item text-danger fw-bold" aria-current="page"><?= $detail['judul'] ?></li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="container feature px-lg-0">
                <div class="row g-0 mx-lg-0">
                    <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                        <div class="p-lg-5 ps-lg-0 text-white">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <div class="owl-carousel header-carousel position-relative h-100">
                            <div class="owl-carousel-item position-relative h-100">
                                <img class="img-fluid" style="object-fit:cover;" src="img/pestcontrol4.jpeg" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative h-100">
                                <img class="img-fluid w-100 h-100" src="img/termite3.jpg" alt="">
                            </div>
                            <div class="owl-carousel-item position-relative h-100">
                                <img class="img-fluid w-100 h-100" src="img/disinfektan3.jpg" alt="">
                        </div>
                        <div class="owl-carousel-item position-relative h-100">
                                <img class="img-fluid w-100 h-100 " src="img/rodent1.jpg" alt="">
                    </div>
  ...
  <div class="sidebar">
    <div class="p-lg-5 ps-lg-10 text-white" style="background:#DC3545">
        <p class="d-inline-block border rounded-pill text-white py-1"><?= $detail['judul'] ?></p>
        <p padding='10' class="text-white "><?= $detail['deskripsi'] ?></p>
    </div>
    <div class="p-lg-5 ps-lg-10 text-white" style="background:#DC3545">
    <p class="d-inline-block border rounded-pill text-white py-1  "><?= $detail['judul'] ?></p>
        <p padding='10' class="text-white "><?= $detail['deskripsi'] ?></p>
    ...
    <div class="p-lg-5 ps-lg-10 text-white" style="background:#DC3545">
    <p class="d-inline-block border rounded-pill text-white py-1 "><?= $detail['judul'] ?></p>
        <p padding='10' class="text-white mb-4 "><?= $detail['deskripsi'] ?></p>
    </div>
    <div class="p-lg-5 ps-lg-10 text-white" style="background:#DC3545">
    <p class="d-inline-block border rounded-pill text-white py-1 "><?= $detail['judul'] ?></p>
        <p padding='10' class="text-white ]"><?= $detail['deskripsi'] ?></p>
  ...
  <div class="main-slide">
    <div style="background-image: url('img/termite3.jpg');"></div>
    <div style="background-image: url('img/disinfektan3.jpg');"></div>
    <div style="background-image: url('img/rodent1.jpg');"></div>
  </div>
  <div class="controls">
