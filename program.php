...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Program Menara Pest</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Tentang Kami</a></li>
                    <li class="breadcrumb-item text-danger active fw-bold" aria-current="page">Program</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <!-- Feature Start -->
    <div class="container-fluid bg-danger overflow-hidden px-lg-0" style="margin: 6rem 0;">
        <div class="container feature px-lg-0">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        <p class="d-inline-block border rounded-pill text-light py-1 px-4">Program</p>
                        <p class="text-white mb-4 pb-2">Menara Pest memiliki program Integrated Pest Management (IPM), yaitu metode untuk mengantisipasi dan mencegah aktivitas hama dan infestasinya dengan mengkombinasikan beberapa strategi yang tepat sasaran dalam pengontrolan hama dalam jangka panjang demi menciptakan suatu area yang bebas dari infestasi hama dengan prioritas pada penggunaan minim kimia, seperti tindakan pencegahan (prevention), eksklusi (exclution) dan sanitasi (sanitation). Pestisida yang digunakan harus dilakukan secara bijaksana dengan memilih dan menggunakan produk-produk yang aman bagi manusia.
                        </p>
                        
                        <p class="text-white mb-4 pb-2">  Tujuan Program ini adalah terwujudnya Service Excellent kepada semua pelanggan demi membuat kehidupan lebih nyaman dan sehat serta terhindar dari gangguan hama dan resiko penyakit maupun kerugian ekonomi yang ditimbulkan oleh hama.
                        </p>
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle " style="width: 55px; height: 55px;">
                ...
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="https://detayilaclamabursa.com/wp-content/uploads/hizmet-isyeri.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
