...
<html lang="en">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Bahan Kimia</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Standar Teknis</a></li>
                    <li class="breadcrumb-item text-danger active" aria-current="page">Bahan Kimia</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex flex-column">
                        <img class="img-fluid rounded align-self-start" src="img/bahankimia.png" width="500px" alt="">
                
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-4">Spesifikasi Bahan Kimia </h1>
                       <p><i class="far fa-check-circle text-danger me-3"></i>Mendapatkan ijin dari Komisi Pestisida - DepTan RI</p>
                    <p><i class="far fa-check-circle text-danger me-3"></i>Bersifat Knock Down</p>
                    <p><i class="far fa-check-circle text-danger me-3"></i>Bersifat Residul</p>
                    <p><i class="far fa-check-circle text-danger me-3"></i>Memiliki MSDS (Material Safety Data Sheet)</p>
                    <p><i class="far fa-check-circle text-danger me-3"></i>Diaplikasikan oleh tenaga terlatih dan menggynakan PPE</p>
