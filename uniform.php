...
<html lang="en">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Uniform Teknisi Menara Pest</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Standar Teknis</a></li>
                    <li class="breadcrumb-item text-danger active" aria-current="page">Uniform Teknisi Menara Pest</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1>Uniform Teknisi Menara Pest</h1>
                <img class="img-fluid rounded mt-5 align-self-start"  width ="800px" src="img/uniform.jpeg" alt="">
            </div>
        </div>
    </div>
    <!-- About End -->
