...
<html lang="en">
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Peralatan Pest Control</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Standar Teknis</a></li>
                    <li class="breadcrumb-item text-danger active" aria-current="page">Peralatan Pest Control</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1>Peralatan Pest Control</h1>
                <img class="img-fluid rounded w-300 mt-5 align-self-start" src="img/peralatan.png" alt="">
            </div>
        </div>
</div>
    <!-- About End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="mb-1"> Peralatan Termite Control (Sistem Umpan) </h1>
                <img class="img-fluid align-self-start" src="img/termitefoto.jpeg" width="500px" alt="">
           
                <p class=" me-3">Sistem umpan berbahan aktif hexaflumuron mampu menggagalkan proses ganti kulit (molting) yang terjadi pada rayap sehingga mengakibatkan kematian pada kelompok rayap pekerja.</p>
                    <p class=" me-3">Sistem Umpan Component Units: </p>
                    <p><i class="far fa-check-circle text-danger me-3"></i>In-Ground Station</p>
                    <p><i class="far fa-check-circle text-danger me-3"></i>Above Ground Station</p>
